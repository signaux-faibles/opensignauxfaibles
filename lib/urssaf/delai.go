...
type Delai struct {
	...
	Denomination      string    `input:"Denomination_premiere_ligne" json:"denomination"       sql:"denomination"         csv:"dénomination"`
	Indic6m           string    `input:"Indic_6M"                    json:"indic_6m"           sql:"indic_6m"             csv:"indic_6mois"`
	AnneeCreation     *int      `input:"Annee_creation"              json:"annee_creation"     sql:"annee_creation"       csv:"année_création"`
