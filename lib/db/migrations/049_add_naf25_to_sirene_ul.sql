ALTER TABLE stg_sirene_ul ADD COLUMN activite_principale_naf25 VARCHAR(10);
...
SELECT
    ...
    s.activite_principale_naf25,
    naf25.niv5_libelle AS libelle_activite_principale_naf25,
    naf25.niv1 AS naf25_section,
    naf25.niv1_libelle AS libelle_naf25_section,
    siege.departement,
...
FROM stg_sirene_ul s
         ...
         LEFT JOIN naf25_codes naf25 ON s.activite_principale_naf25 = naf25.niv5
...
ALTER TABLE stg_sirene_ul DROP COLUMN activite_principale_naf25;
