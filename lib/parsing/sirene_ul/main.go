...
func (parser *sireneULParser) Init(cache *engine.Cache, batch *base.AdminBatch) error {
	return nil
}
...
func (parser *sireneULParser) ParseLines(parsedLineChan chan engine.ParsedLineResult) {
...
func parseSireneUlLine(idx engine.ColMapping, row []string, parsedLine *engine.ParsedLineResult) {
