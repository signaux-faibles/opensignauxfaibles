...
func (parser *sireneParser) Init(_ *engine.Cache, _ *base.AdminBatch) error {
	return nil
}
...
func (parser *sireneParser) ParseLines(parsedLineChan chan engine.ParsedLineResult) {
...
func parseLine(idx engine.ColMapping, row []string, parsedLine *engine.ParsedLineResult) {
	var err error
