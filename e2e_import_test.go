...
func createImportTestBatch(t *testing.T) {
	...
	batch := base.AdminBatch{
		...
		Files: map[base.ParserType][]base.BatchFile{
			Dummy:            {},
			base.Filter:      {},
			base.Apconso:     {base.BatchFile("./lib/apconso/testData/apconsoTestData.csv")},
			base.Apdemande:   {base.BatchFile("./lib/apdemande/testData/apdemandeTestData.csv")},
			base.Sirene:      {base.BatchFile("./lib/sirene/testData/sireneTestData.csv")},
			base.SireneUl:    {base.BatchFile("./lib/sirene_ul/testData/sireneULTestData.csv")},
			base.AdminUrssaf: {base.BatchFile("./lib/urssaf/testData/comptesTestData.csv")},
			base.Debit:       {base.BatchFile("./lib/urssaf/testData/debitTestData.csv")},
			base.Ccsf:        {base.BatchFile("./lib/urssaf/testData/ccsfTestData.csv")},
			base.Cotisation:  {base.BatchFile("./lib/urssaf/testData/cotisationTestData.csv")},
			base.Delai:       {base.BatchFile("./lib/urssaf/testData/delaiTestData.csv")},
			base.Effectif:    {base.BatchFile("./lib/urssaf/testData/effectifTestData.csv")},
			base.EffectifEnt: {base.BatchFile("./lib/urssaf/testData/effectifEntTestData.csv")},
			base.Procol:      {base.BatchFile("./lib/urssaf/testData/procolTestData.csv")},
		},
